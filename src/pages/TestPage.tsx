                ...
                {questions.map(question => (
                    <div className="card" key={index}>
                        ...
                        <div className="answers">
                            <input type="radio" name={question.id} id={"radio"+index} value={"a"}/>
                            <label htmlFor={"radio"+index++}>{question.answerA}</label>
                        </div>
                        <div className="answer">
                            <input type="radio" name={question.id} id={"radio"+index} value={"b"}/>
                            <label htmlFor={"radio"+index++}>{question.answerB}</label>
                        </div>
                        <div className="answer">
                            <input type="radio" name={question.id} id={"radio"+index} value={"c"}/>
                            <label htmlFor={"radio"+index++}>{question.answerC}</label>
                        </div>
                        <div className="answer">
                            <input type="radio" name={question.id} id={"radio"+index} value={"d"}/>
